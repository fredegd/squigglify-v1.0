    ...
    <>
      <div className="relative h-full flex flex-col">
        <div className="space-y-4 flex-1 flex flex-col ">
          <div className="flex flex-col lg:w-full  border border-gray-700 rounded-2xl overflow-hidden p-2 relative flex flex-col">
...
export const ImageThumbnail = memo(function ImageThumbnail({
  ...
  return (
    <div className="bg-gray-800/95 backdrop-blur-md rounded-b-lg sticky top-0 lg:top-20 z-[45] pt-16 lg:pt-0 px-7 lg:px-0  shadow-xl">
